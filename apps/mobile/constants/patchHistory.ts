...
export const PATCH_HISTORY: PatchEntry[] = [
  {
    ...
    added: [
      ...
      '📈 Mastery: Yield +3%/level, Speed +4%/level (max 3 each) for all 10 skills. Pillar UI in Settings.',
      ...
      '⚒️ Runite forging: Dagger, sword, half helmet, full helmet, platebody, shield. Story-gated. Swords, platebodies, shields for all tiers (Bronze→Runite).',
