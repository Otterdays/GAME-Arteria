...
export const PATCH_HISTORY: PatchEntry[] = [
  ...
  },
  {
    ...
    added: [
      ...
      '🌾 New Skill: Farming. Plant seeds in 3 patches (Crownlands Farm, Frostvale Greenhouse), wait for real-time growth, then harvest. 7 crops from wheat to void cap. Seeds from shop; Bank Seeds filter.',
      '🔥 New Skill: Firemaking. Burn logs for XP. 9 burn types from Normal Log to Cosmic Wood. Consumes logs from inventory; higher-tier logs grant more XP.',
      '🪵 New Skill: Woodworking. Turn logs into furniture, shields, and staves. Flagship workbench UI with category rail, recipe cards (input/output slots), and sticky action dock. 5 recipes: Pine Stool, Maple Dining Table, Training Staff, Willow Shield, Barrel.',
      '🗺️ New Skill: Exploration. Survey routes, chart regions, and discover. 6 expeditions (Crownlands Paths to Skyward Ascent) earn XP and discovery items. World Map locations now unlock by Exploration level — train to open Scorched Reach and Skyward Peaks!',
      '📜 New Skill: Wizardry. Study tomes and scrolls for XP. 3 study nodes from Basic Scroll Reading to Celestial Almanac.',
      '🪄 New Skill: Sorcery. Cast spells by consuming runes — Lumina Spark, Voidmire Bolt, Astral Storm. Craft runes at Runecrafting first!',
    ...
    fixed: [
      ...
      '⏳ WYWA Offline XP Fix: Offline gains (XP, items, gold) now apply when you tap "Collect & Continue" instead of during calculation. Ensures gains are always applied correctly.',
