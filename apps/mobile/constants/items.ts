...
export const ITEM_META: Record<string, ItemMeta> = {
  ...
  bronze_sword: { emoji: '⚔️', label: 'Bronze Sword', sellValue: 45, description: 'A basic bronze sword. Heavier than a dagger.', type: 'equipment' },
  ...
  iron_sword: { emoji: '⚔️', label: 'Iron Sword', sellValue: 110, description: 'A sturdy iron sword.', type: 'equipment' },
  ...
  steel_sword: { emoji: '⚔️', label: 'Steel Sword', sellValue: 220, description: 'A keen steel sword.', type: 'equipment' },
  ...
  mithril_sword: { emoji: '⚔️', label: 'Mithril Sword', sellValue: 650, description: 'A mithril sword. Light and deadly.', type: 'equipment' },
  ...
  adamant_sword: { emoji: '⚔️', label: 'Adamant Sword', sellValue: 1300, description: 'An adamant sword. Devastating.', type: 'equipment' },
  ...
  runite_sword: { emoji: '⚔️', label: 'Runite Sword', sellValue: 5000, description: 'A runite sword. The finest blade.', type: 'equipment' },
