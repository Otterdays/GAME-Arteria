...
## Current Tasks
- [x] **ANDROID_STUDIO_ONBOARDING.md (2026-03-22):** New doc for clones — CNG means `apps/mobile/android` is generated; open that folder after `expo prebuild`, not `android/app` or empty root `android`. Linked from SUMMARY index and EXPO_GUIDE §8.
