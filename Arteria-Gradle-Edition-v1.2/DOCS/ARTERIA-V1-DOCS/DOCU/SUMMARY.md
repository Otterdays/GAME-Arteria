...
| **ANDROID_STUDIO_ONBOARDING.md** | After clone: why `android/` is missing, run `expo prebuild`, open `apps/mobile/android` in Android Studio (not `android/app` or empty root `android`). |
